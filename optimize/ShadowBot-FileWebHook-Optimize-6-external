...
第二个脚本名字叫ShadowbotAppFormwork_InstructDataCopyPaste.py 作用是读取C:\project\ShadowBot-FileWebHook\shadowbot\InstructData文件 然后将内容写入当前系统剪贴板内
我这么做是为了  为了让你更好的理解这个需求  我把之前这个需求的对话背景发给你  如下：
